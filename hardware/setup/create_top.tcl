...
connect_bd_net [get_bd_pins A1_0/ap_clk_0] [get_bd_pins oc_host_if_0/clock_afu]
...
#ipx::package_project -root_dir $project_dir/ip_repo -vendor opencapi.org -library ocaccel -taxonomy /UserIP -module T1 -import_files
#
#set_property core_revision 2 [ipx::find_open_core opencapi.org:ocaccel:T1:1.0]
#ipx::create_xgui_files [ipx::find_open_core opencapi.org:ocaccel:T1:1.0]
#ipx::update_checksums [ipx::find_open_core opencapi.org:ocaccel:T1:1.0]
#ipx::save_core [ipx::find_open_core opencapi.org:ocaccel:T1:1.0]
