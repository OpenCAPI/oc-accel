...
export_simulation -force -directory "$hardware_build_dir/sim" -simulator xcelium -lib_map_path "$ies_libs" -ip_user_files_dir "$hardware_build_dir/output/top_project/top_project.ip_user_files" -ipstatic_source_dir "$hardware_build_dir/output/top_project/top_project.ip_user_files/ipstatic" -use_ip_compiled_libs >> $log_file
