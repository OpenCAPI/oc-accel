...
set hw_root_dir        $::env(OCACCEL_HARDWARE_ROOT)
set fpga_part          $::env(FPGACHIP)
set fpga_card          $::env(FPGACARD)
set action_name        $::env(ACTION_NAME)
set kernel_name        $::env(KERNEL_NAME)
set project            "top_project"
set project_dir        $hw_root_dir/build/$project
set engine_ip_repo_dir $root_dir/actions/$action_name/hw/hls/$::env(ACTION_NAME)_${fpga_part}/$kernel_name/impl/ip

set ip_repo_dir     $hw_root_dir/build/ip_repo
set interfaces_dir  $hw_root_dir/build/interfaces
set bd_name         "top"

create_project $project $project_dir -part $fpga_part -force
create_bd_design $bd_name
set_property  ip_repo_paths  [list $engine_ip_repo_dir $ip_repo_dir $interfaces_dir] [current_project]
update_ip_catalog
add_files -norecurse $hw_root_dir/oc-accel-bsp/AD9V3/hdl/misc/iprog_icap.vhdl


# Add sub block designs
# bd_act and bd_infra
source $hw_root_dir/setup/package_action/bd_action_template_A10.tcl
source $hw_root_dir/setup/package_infrastructure/bd_infra_template_T1.tcl
...
# TODO: interrupt disabled for now
...
# TODO: assume only 1 engine is connected
connect_bd_intf_net [get_bd_intf_pins bd_infra/bridge_axi_slave/s_axi] [get_bd_intf_pins action_wrapper/pin_eng00_aximm]
connect_bd_intf_net [get_bd_intf_pins bd_infra/mmio_axilite_master/m_axi] [get_bd_intf_pins action_wrapper/pin_eng00_axilite]
...
connect_bd_net [get_bd_pins oc_host_if/clock_afu] [get_bd_pins action_wrapper/pin_clock_action]
...
connect_bd_net [get_bd_pins oc_host_if/reset_afu_n] [get_bd_pins action_wrapper/pin_reset_action_n]
...
#        $hw_root_dir/oc-accel-bsp/$fpga_card/xdc/qspi_timing.xdc \
#
#
add_files -fileset constrs_1 -norecurse  [list \
                                         $hw_root_dir/oc-accel-bsp/$fpga_card/xdc/gty_properties.xdc \
                                         $hw_root_dir/oc-accel-bsp/$fpga_card/xdc/main_pinout.xdc \
                                         $hw_root_dir/oc-accel-bsp/$fpga_card/xdc/main_placement_bypass.xdc \
                                         $hw_root_dir/oc-accel-bsp/$fpga_card/xdc/main_timing.xdc \
                                         $hw_root_dir/oc-accel-bsp/$fpga_card/xdc/bitstream_config.xdc \
                                         $hw_root_dir/oc-accel-bsp/$fpga_card/xdc/qspi_pinout.xdc \
                                         ] 
