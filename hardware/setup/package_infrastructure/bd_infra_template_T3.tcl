...
connect_bd_net [get_bd_pins $bd_hier/pin_reset_action_n ] [get_bd_pins $bd_hier/job_manager/resetn          ]
    for {set x 0} {$x < $kernel_number } {incr x} {
        set xx [format "%02d" $x]
        create_bd_pin -dir I $bd_hier/kernel_ready${xx}
        create_bd_pin -dir O $bd_hier/kernel_data${xx}
        create_bd_pin -dir O $bd_hier/kernel_start${xx}
        create_bd_pin -dir I $bd_hier/complete_data${xx}
        create_bd_pin -dir I $bd_hier/complete_ready${xx}
        create_bd_pin -dir I $bd_hier/complete_accept${xx}
        connect_bd_net [get_bd_pins $bd_hier/kernel_start${xx}      ] [get_bd_pins $bd_hier/job_manager/kernel_start${xx}   ]
        connect_bd_net [get_bd_pins $bd_hier/kernel_ready${xx}      ] [get_bd_pins $bd_hier/job_manager/kernel_ready${xx}   ]
        connect_bd_net [get_bd_pins $bd_hier/kernel_data${xx}       ] [get_bd_pins $bd_hier/job_manager/kernel_data${xx}    ]
        connect_bd_net [get_bd_pins $bd_hier/complete_accept${xx}   ] [get_bd_pins $bd_hier/job_manager/complete_accept${xx}]
        connect_bd_net [get_bd_pins $bd_hier/complete_ready${xx}    ] [get_bd_pins $bd_hier/job_manager/complete_ready${xx} ]
        connect_bd_net [get_bd_pins $bd_hier/complete_data${xx}     ] [get_bd_pins $bd_hier/job_manager/complete_data${xx}  ]
    }
