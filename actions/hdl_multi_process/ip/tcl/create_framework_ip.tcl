...
puts "                        Generating addr_ram_hi ......"
create_ip -name dist_mem_gen -vendor xilinx.com -library ip -version 8.0 -module_name addr_ram_hi > $log_file
set_property -dict [list CONFIG.depth {512} CONFIG.data_width {32} CONFIG.memory_type {simple_dual_port_ram}] [get_ips addr_ram_hi]
set_property generate_synth_checkpoint false [get_files $src_dir/addr_ram_hi/addr_ram_hi.xci] > $log_file
generate_target all [get_files $src_dir/addr_ram_hi/addr_ram_hi.xci] > $log_file

puts "                        Generating addr_ram_lo ......"
create_ip -name dist_mem_gen -vendor xilinx.com -library ip -version 8.0 -module_name addr_ram_lo > $log_file
set_property -dict [list CONFIG.depth {512} CONFIG.data_width {32} CONFIG.memory_type {simple_dual_port_ram}] [get_ips addr_ram_lo]
set_property generate_synth_checkpoint false [get_files $src_dir/addr_ram_lo/addr_ram_lo.xci] > $log_file
generate_target all [get_files $src_dir/addr_ram_lo/addr_ram_lo.xci] > $log_file
