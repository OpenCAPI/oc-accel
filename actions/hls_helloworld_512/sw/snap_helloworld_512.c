...
static void usage(const char *prog)
{
	...
	"echo \"Hello world_512. This is my first CAPI SNAP experience. It's real fun.\""
	" > /tmp/t1\n"
	"\n"
	"echo Run the application + hardware action\n"
	"snap_helloworld_512 -i /tmp/t1 -o /tmp/t2\n"
...
static void snap_prepare_helloworld_512(struct snap_job *cjob,
				 struct helloworld_512_job *mjob,
				 void *addr_in,
				 uint32_t size_in,
				 uint8_t type_in,
				 void *addr_out,
...
/* main program of the application for the hls_helloworld_512 example        */
...
int main(int argc, char *argv[])
{
	...
	snap_prepare_helloworld_512(&cjob, &mjob,
	...
	fprintf(stdout, "SNAP helloworld_512 took %lld usec\n",
