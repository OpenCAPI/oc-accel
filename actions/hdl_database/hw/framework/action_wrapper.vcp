...
// AXI Host Memory Interface
    ...
    wire [7:0] num_kernels;
    wire [7:0] num_pkt_pipes;
    wire [7:0] num_patt_pipes;
    wire [7:0] version;
    wire [31:0] action_version;
    assign num_kernels = KERNEL_NUM;
    assign num_pkt_pipes = NUM_STRING_MATCH_PIPELINE;
    assign num_patt_pipes = NUM_OF_PU;
    assign version = 8'h01;
    assign m_axi_host_mem_arid[C_M_AXI_HOST_MEM_ID_WIDTH-1:4] = 0;
    assign action_version = {num_patt_pipes, num_pkt_pipes, num_kernels, version};
...
// AXI read address channel
        .m_axi_snap_arid (m_axi_host_mem_arid[3:0]),
