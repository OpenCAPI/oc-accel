...
/*
 * SNAP HLS_HELLOWORLD_1024 EXAMPLE
 *
 * Tasks for the user:
	      ...
	      action_reg *act_reg)
{
    ...
    i_idx = act_reg->Data.in.addr >> ADDR_RIGHT_SHIFT_1024;
    o_idx = act_reg->Data.out.addr >> ADDR_RIGHT_SHIFT_1024;
...
//#pragma HLS PIPELINE
	...
	bytes_to_transfer = MIN(size, BPERDW_1024);

        /* Read in one word_t */
	memcpy((char*) text, din_gmem + i_idx, BPERDW_1024);
...
//#pragma HLS UNROLL
	...
	memcpy(dout_gmem + o_idx, (char*) text, BPERDW_1024);
...
//--- TOP LEVEL MODULE -------------------------------------------------
// snap_membus_1024_t is defined in actions/include/hls_snap_1024.H
void hls_action(snap_membus_1024_t *din_gmem,
	snap_membus_1024_t *dout_gmem,
	/* snap_membus_1024_t *d_ddrmem, // CAN BE COMMENTED IF UNUSED */
	action_reg *act_reg)
{
    // Host Memory AXI Interface - CANNOT BE REMOVED - NO CHANGE BELOW
#pragma HLS INTERFACE m_axi port=din_gmem bundle=host_mem offset=slave depth=1024 \
  max_read_burst_length=64  max_write_burst_length=64
#pragma HLS INTERFACE s_axilite port=din_gmem bundle=ctrl_reg offset=0x030

#pragma HLS INTERFACE m_axi port=dout_gmem bundle=host_mem offset=slave depth=1024 \
  max_read_burst_length=64  max_write_burst_length=64
#pragma HLS INTERFACE s_axilite port=dout_gmem bundle=ctrl_reg offset=0x040

/*  // DDR memory Interface - CAN BE COMMENTED IF UNUSED
 * #pragma HLS INTERFACE m_axi port=d_ddrmem bundle=card_mem0 offset=slave depth=1024 \
 *   max_read_burst_length=64  max_write_burst_length=64
...
#define MEMORY_LINES 1
    int rc = 0;
    unsigned int i;
    static snap_membus_1024_t  din_gmem[MEMORY_LINES];
    static snap_membus_1024_t  dout_gmem[MEMORY_LINES];
